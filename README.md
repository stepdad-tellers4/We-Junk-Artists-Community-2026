...
# 🎮 We, Junk Artists — Community Edition

**Turn discarded junk into creative masterpieces in this standalone build.**
...
We, Junk Artists is a creative crafting simulation where players collect discarded junk and transform it into art, gadgets, and functional creations. This Community Edition is a standalone build distributed as a self-contained package. No storefront required and no additional software needed — the game is ready to play immediately after installation.

This build is for players who enjoy relaxing crafting simulations and creative sandbox games on Windows PC.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3470550/ee6069552acf1e19cb8e9dc7b7966da0022732ca/ss_ee6069552acf1e19cb8e9dc7b7966da0022732ca.1920x1080.jpg?t=1786454701" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3470550/f9ef04d3ddee495f8f054efd002fdadb6656ba65/ss_f9ef04d3ddee495f8f054efd002fdadb6656ba65.1920x1080.jpg?t=1786454701" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3470550/0f9121a79e125d8a1d63afc9c85c8e8c1f7ea95f/ss_0f9121a79e125d8a1d63afc9c85c8e8c1f7ea95f.1920x1080.jpg?t=1786454701" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🗜️ **Junk Crafting System** — Collect scrap, salvage, and discarded materials to assemble new creations.
- 🎨 **Creative Freedom** — Build art pieces, gadgets, and contraptions with no fixed blueprint restrictions.
- 🧰 **Workshop Management** — Organize your workspace, sort materials, and optimize your crafting flow.
- 🌍 **Explorable Environments** — Search locations for valuable junk and hidden salvage opportunities.
- 🔧 **Tool Progression** — Improve your toolkit as projects grow larger and more complex.
- 📦 **Resource Collection** — Gather components item by item and manage your growing inventory.
- 🖌️ **Customization Options** — Personalize finished creations with paint, parts, and decorative touches.
- 📈 **Project Milestones** — Progress through increasingly ambitious builds at your own pace.
- 🎧 **Original Soundtrack** — Includes the full in-game soundtrack as part of this complete release.
- 🖥️ **Lightweight Performance** — Runs smoothly on modest hardware with low system requirements.
- 📂 **Self-Contained Package** — All files included in one installation — no additional downloads required.
- 💾 **Offline Play** — Fully playable offline with no account or storefront required.
...
| **Processor** | Intel Core i3-2100 or AMD equivalent, 2.0 GHz dual-core | Intel Core i5-4460 or AMD Ryzen 3 1200 |
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 650 / AMD Radeon HD 7750, 1 GB VRAM | NVIDIA GeForce GTX 960 / AMD Radeon R9 380, 2 GB VRAM |
| **Storage** | 4 GB available space | 4 GB available space on SSD |
| **Additional** | DirectX 11 compatible sound card | DirectX 11 compatible sound card, controller supported |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\We,JunkArtists\Saved`
